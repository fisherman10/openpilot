...
PersonalisedPanel::PersonalisedPanel(QWidget* parent) : ListWidget(parent) {
  ...
  fanPwmOverrideSb = new SpinboxControl("FanPwmOverride","Fan Speed", "Note: Lowering the fan speed may reduce the overall fan noise but risk of device overheating.", "%", (double []){0, 100.0, 1.0}, false);
