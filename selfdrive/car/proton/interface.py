...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=None):
    ...
    if candidate == CAR.X50:
      ...
      ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0., 20., 25.], [600, 600, 610]] #maximum is 600 only. Any more it will disengage and reengage on its own.
      ...
      ret.lateralTuning.pid.kf = 0.0001000000
