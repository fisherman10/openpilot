...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=None):
    ...
    ret.steerLimitTimer = 0.001            # time before steerLimitAlert is issued
    ret.steerControlType = car.CarParams.SteerControlType.torque
    ret.steerActuatorDelay = 0.001         # Steering wheel actuator delay in seconds
    ...
    if candidate == CAR.X50:
      ...
      ret.lateralTuning.pid.kpBP = [0., 17., 25., 35., 40.]
<<<<<<< HEAD
      ret.lateralTuning.pid.kpV = [0.04, 0.12, 0.13, 0.15, 0.15]
      ret.lateralTuning.pid.kiBP = [0., 30., 40.]
      ret.lateralTuning.pid.kiV = [0.015, 0.02, 0.04]
=======
      ret.lateralTuning.pid.kpV = [0.04, 0.11, 0.12, 0.15, 0.15]
      ret.lateralTuning.pid.kiBP = [0., 40.]
      ret.lateralTuning.pid.kiV = [0.015, 0.025]
>>>>>>> c20dbecaa655616823fd9d675770609fec57104b
      ret.lateralTuning.pid.kf = 0.0000937834070000000000
