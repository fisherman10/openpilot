...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=None):
    ...
    ret.steerActuatorDelay = 0.15         # Steering wheel actuator delay in seconds
    ...
    if candidate == CAR.X50:
      ...
      ret.lateralTuning.pid.kpV = [0.05, 0.12, 0.14, 0.16, 0.17]
      ret.lateralTuning.pid.kiBP = [0., 40.]
      ret.lateralTuning.pid.kiV = [0.02, 0.03]
      ret.lateralTuning.pid.kf = 0.00009378341340000000000
