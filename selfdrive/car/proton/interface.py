...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=None):
    ...
    ret.steerRateCost = 2.0              #steerRateCost lower is more reactive and higher is slower to react. Adjusting steerRateCost will affect how eager the car is to make sudden direction changes. Lower cost == more eager
    ...
    if candidate == CAR.X50:
      ...
      ret.lateralTuning.pid.kpV = [0.04, 0.08, 0.10, 0.12, 0.14]
      ret.lateralTuning.pid.kiBP = [0., 20., 25., 30., 40.]
      ret.lateralTuning.pid.kiV = [0.005, 0.005, 0.005, 0.005, 0.005]
      ret.lateralTuning.pid.kf = 0.00009145000000000
