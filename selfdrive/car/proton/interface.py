...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=None):
    ...
    if candidate == CAR.X50:
      ...
      ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0.], [620]]  #maximum is 600 only. Any more it will disengage and reengage on its own.

      ret.lateralTuning.pid.kpBP = [0., 15., 25., 35., 40.]
      ret.lateralTuning.pid.kpV = [0.03, 0.14, 0.16, 0.17, 0.17]
      ret.lateralTuning.pid.kiBP = [0., 20., 25., 30., 40.]
      ret.lateralTuning.pid.kiV = [0.03, 0.02, 0.02, 0.02, 0.02]
      ret.lateralTuning.pid.kf = 0.0000934170000000
